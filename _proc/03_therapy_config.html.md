---
output-file: therapy_config.html
title: Runtime configuration for string therapy (local dev, pixi , packaged install)
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L135){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L116){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L110){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L104){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L99){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L88){target="_blank" style="float:right; font-size:smaller"}
...
ERR_EMPTY_RESPONSE. Prefer `[`web_app_url()`](https://alix559.github.io/string_therapy/therapy_config.html#web_app_url)` in the browser, or set ``ST_BIND_HOST=::``
so ``localhost`` works (Linux; ``127.0.0.1`` may then need the same stack).


---

[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L82){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L69){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L51){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L27){target="_blank" style="float:right; font-size:smaller"}
...
[source](https://github.com/alix559/string_therapy/blob/main/string_therapy/therapy_config.py#L19){target="_blank" style="float:right; font-size:smaller"}
